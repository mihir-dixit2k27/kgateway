...
// +kubebuilder:rbac:groups=gateway.networking.x-k8s.io,resources=listenersets,verbs=get;list;watch
...
// +kubebuilder:rbac:groups=gateway.networking.x-k8s.io,resources=listenersets/status,verbs=patch;update
